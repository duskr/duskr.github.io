...
- Deleting the "Our clients" and "Testimonial" part in layouts/index.html (riginal file at layouts/index_ORIG.html)
- same edit for layout/about.html
- Changing font from Raleway to HelveticaNeue-Light with various weight
